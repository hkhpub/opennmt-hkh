...
cat $BT_DIR/syn.train.0.4m.tok.clean.bpe32k.ko "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$SRC" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$SRC"
cat $BT_DIR/train.0.4m.tok.clean.bpe32k.en "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$TGT" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$TGT"
