...
#======= EXPERIMENT SETUP ======
NAME=data.emb.langid.0.4m.bt.ko-en
...
cat $BT_DIR/emb.langid.syn.train.0.4m.tok.clean.bpe32k.ko "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$SRC" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$SRC"
cat $BT_DIR/emb.langid.train.0.4m.tok.clean.bpe32k.en "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$TGT" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$TGT"
...
-config $ONMT/config/ted2013.50k.ko-en.yml \
