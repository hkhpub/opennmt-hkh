...
#======= EXPERIMENT SETUP ======
NAME=data.ranked.period.0.4m.bt.ko-en
DATA_DIR="/home/hkh/data/ted2013/data.ko-en"
OUTPUT_DIR="/home/hkh/data/ted2013/opennmt.$NAME"
BT_DIR=/home/hkh/data/wmt16_en_data/encoder_ranked
...
cat $BT_DIR/ranked.period.syn.train.0.4m.tok.clean.bpe32k.ko "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$SRC" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$SRC"
cat $BT_DIR/ranked.period.train.0.4m.tok.clean.bpe32k.en "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$TGT" > "$OUTPUT_DIR/train.merge.tok.clean.bpe32k.$TGT"
