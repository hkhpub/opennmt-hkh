...
#======= EXPERIMENT SETUP ======
NAME=data.bilingual.ko-en
DATA_DIR="/home/hkh/data/ted2013/data.ko-en"
BILINGUAL_DIR="/home/hkh/data/ted2013/$NAME"
...
cat "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$SRC" "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$TGT" > "$BILINGUAL_DIR/train.bilingual.tok.clean.bpe32k.$SRC"
cat "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$TGT" "$DATA_DIR/train.ko-en.tok.clean.bpe32k.$SRC" > "$BILINGUAL_DIR/train.bilingual.tok.clean.bpe32k.$TGT"

TRAIN_SRC="$BILINGUAL_DIR/train.bilingual.tok.clean.bpe32k.$SRC"
TRAIN_TGT="$BILINGUAL_DIR/train.bilingual.tok.clean.bpe32k.$TGT"
